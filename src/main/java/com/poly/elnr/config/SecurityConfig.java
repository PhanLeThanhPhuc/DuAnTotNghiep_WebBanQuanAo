...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http.csrf().disable()
					...
					.requestMatchers("/assets/admin/**").hasAnyAuthority("ROLE_ADMIN","ROLE_STAFF")
					.requestMatchers("/rest/authorities", "/rest/orderTotal","/rest/phone-total").hasAnyAuthority("ROLE_ADMIN")
